...
const GsapTimeline = () => {
  ...
  useGSAP(() => {
    timeline.to("#yellow-box", { x: 250, rotation: 360, borderRadius: "100%", ease: "back.inOut" })
    timeline.to("#yellow-box", { y: -250, rotation: 360, borderRadius: "100%", ease: "back.inOut" })
    timeline.to("#yellow-box", { x: 500, rotation: 360, borderRadius: "10px", ease: "back.inOut" })
  }, [])
